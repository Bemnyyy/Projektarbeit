...
def plot_2(data):
    ...
    ax = data[['tavg', 'tsun']].plot(kind='line', figsize=(12, 4))
...
def plot_3(data):
    ...
    ax = data[['tavg', 'tsun']].plot(kind='bar', stacked=True, figsize=(12, 4))
    ax.set_xlabel('Stunde')
...
def plot_4(data):
    ...
    ax = data[['tavg', 'tsun']].plot(kind='bar', figsize=(12, 4))
    ax.set_xlabel('Stunde')
    ax.set_ylabel('Wert')
    ax.set_title(f'Niederschlag & Sonnenscheindauer – stündlich am {start} bis {end}')
